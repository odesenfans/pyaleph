...
from aleph.schemas.raw_messages import parse_message, RawStoreMessage
...
async def test_handle_new_storage_invalid_content(
    mock_config, fixture_message_directory: RawStoreMessage
):
...
async def test_handle_new_storage_file(
    mocker, mock_config, fixture_message_file: RawStoreMessage
):
...
async def test_handle_new_storage_directory(
    mocker, mock_config, fixture_message_directory: RawStoreMessage
):
...
async def test_handle_new_storage_invalid_hash(
    mock_config, fixture_message_file: RawStoreMessage
):
    content = json.loads(fixture_message_file.item_content)
