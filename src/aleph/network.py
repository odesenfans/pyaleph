...
from aleph.schemas.raw_messages import parse_message, BaseRawMessage
...
async def get_pubsub_message(ipfs_pubsub_message: Dict) -> BaseRawMessage:
    """
...
async def verify_signature(message: BaseRawMessage) -> None:
    chain = message.chain
